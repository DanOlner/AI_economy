...
```{r}
LAsummary <- readRDS('../../local/data/LAsummary_1to3employees_4_AI_measures_weightedmeans.rds')
...
LAsummary <- readRDS('../../local/data/LAsummary_4plus_employees_4_AI_measures_weightedmeans.rds')
